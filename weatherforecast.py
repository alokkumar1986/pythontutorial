...
# Image
new = ImageTk.PhotoImage(Image.open('C:/Users/ISU_375/Desktop/pythontutorial/logo.png'))
...
if int((dt.strftime('%I'))) >= 8 & int((dt.strftime('%I'))) <= 5:
    ...
    img = ImageTk.PhotoImage(Image.open('C:/Users/ISU_375/Desktop/pythontutorial/sun.png'))
    panel = Label(root, image=img)
    panel.place(x=210, y=200)
